        ...
        <div class="max-w-4xl mx-auto">
            ...
            <article class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12 prose prose-lg dark:prose-invert max-w-none">
                ...
                <div class="border-t dark:border-gray-700 mt-12 pt-8">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="px-4 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-sm">
                            #{{ $tag->name }}
                        </span>
                        @endforeach
                    </div>
            ...
            <nav class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a href="{{ route('public.posts.details', $previousPost->id) }}" 
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white group-hover:text-blue-600 transition-colors duration-200">
                        {{ $previousPost->title }}
                    </h4>
                </a>
                @endif
...
<section class="py-24 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                <div class="relative overflow-hidden">
                    <img 
                        src="{{ $relatedPost->image ? asset('storage/' . $relatedPost->image) : 'https://picsum.photos/800/600?education=' . $loop->iteration }}" 
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3 group-hover:text-blue-600 transition-colors duration-200">
                        {{ $relatedPost->title }}
                    </h3>
